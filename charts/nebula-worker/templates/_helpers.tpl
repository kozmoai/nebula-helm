...
{{/*
Require Nebula Cloud Account ID
*/}}
{{- define "cloud.requiredConfig.accountId" -}}
{{- if eq .Values.worker.apiConfig "cloud" }}
    {{- required "A Nebula Cloud Account ID is required (worker.cloudApiConfig.accountId)" .Values.worker.cloudApiConfig.accountId -}}
{{- end -}}
{{- end -}}

{{/*
Require Nebula Cloud Workspace ID
*/}}
{{- define "cloud.requiredConfig.workspaceId" -}}
{{- if eq .Values.worker.apiConfig "cloud" }}
    {{- required "A Nebula Cloud Workspace ID is required (worker.cloudApiConfig.workspaceId)" .Values.worker.cloudApiConfig.workspaceId -}}
{{- end -}}
{{- end -}}
...
{{- if eq .Values.worker.apiConfig "selfHosted" }}
    {{- required "A Nebula Cloud Account ID is required (worker.selfHostedCloudApiConfig.accountId)" .Values.worker.selfHostedCloudApiConfig.accountId -}}
{{- end -}}
{{- end -}}
...
{{- if eq .Values.worker.apiConfig "selfHosted" }}
    {{- required "A Nebula Cloud Workspace ID is required (worker.selfHostedCloudApiConfig.workspaceId)" .Values.worker.selfHostedCloudApiConfig.workspaceId -}}
{{- end -}}
{{- end -}}
...
{{/*
Require Nebula Server API URL
*/}}
{{- define "server.requiredConfig.apiUrl" -}}
{{- if eq .Values.worker.apiConfig "server" }}
    {{- required "The Nebula Server API URL is required (worker.serverApiConfig.apiUrl)" .Values.worker.serverApiConfig.apiUrl -}}
{{- end -}}
{{- end -}}
...
{{- if eq .Values.worker.apiConfig "cloud" }}
    {{- printf "https://app.nebula.cloud/account/%s/workspace/%s" (include "cloud.requiredConfig.accountId" .) (include "cloud.requiredConfig.workspaceId" .) | quote }}
{{- else if eq .Values.worker.apiConfig "selfHosted" }}
